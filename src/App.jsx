...
const translations = {
  uz: {
    ...
    contact_desc: "O'z savollaringiz yoki takliflaringizni qoldiring.",
  ...
  ru: {
    ...
    contact_desc: "Оставьте нам вопросы или предложения.",
  ...
  en: {
    ...
    contact_desc: "Please leave your questions or suggestions.",
